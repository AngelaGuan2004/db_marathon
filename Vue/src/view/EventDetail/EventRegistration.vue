    ...
    <div class="RegistrationContainer">
      ...
      <el-form :model="participant" label-width="130px">
        ...
        <el-form-item label="选手性别">
          <el-radio v-model="radio" label="男" style="margin-left: 5%;">男</el-radio>
        ...
        <el-form-item label="地区">
          <div>
            <el-select v-model="selectedProvince" placeholder="请选择省份" size="mini">
              <el-option v-for="province in provinces" :key="province" :value="province"></el-option>
            </el-select>
            <el-select v-model="selectedCity" placeholder="请选择城市" size="mini">
