          ...
          <div class="Tab" style="margin-top: 0;">
            <el-menu ref="EventManagementTab" :default-active="ActiveIndexForEventManagementTab"
              ...
              <el-submenu index="333" menu-trigger="hover">
                ...
                <el-menu-item index="4">物资包管理</el-menu-item>
                <el-menu-item index="5">医疗点管理</el-menu-item>
                <el-menu-item index="6">接驳车管理</el-menu-item>
                <el-menu-item index="7">补给点增删</el-menu-item>
                <el-menu-item index="8" style="margin-bottom: 10px;">补给点物资管理</el-menu-item>
              </el-submenu>
            </el-menu>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      IsLottery: false,
      EventManagementTabTitle: ['ParticipantLottery', 'PacerSelection', 'EmergencyRunnerSelection', 'PackageManagement', 'MedicalPointManagement', 'ShuttleManagement', 'SupplyPointDeleteManagement', 'SupplypointManagement'],
    };
  },
  methods: {
    ActiveIndex(index) {
