...
export default {
  data() {
    return {
      ...
      participants: [
        { "id": "1", "name": "张三", "sex": "男", "age": "30", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "2", "name": "李四", "sex": "女", "age": "22", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "3", "name": "王五", "sex": "男", "age": "45", "role": "慈善跑者", "state": "-", "number": "-" },
        { "id": "4", "name": "赵六", "sex": "女", "age": "28", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "5", "name": "孙七", "sex": "男", "age": "36", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "6", "name": "周八", "sex": "女", "age": "25", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "7", "name": "吴九", "sex": "男", "age": "40", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "8", "name": "郑十", "sex": "女", "age": "33", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "9", "name": "冯十一", "sex": "男", "age": "27", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "10", "name": "陈十二", "sex": "女", "age": "31", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "11", "name": "褚十三", "sex": "男", "age": "29", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "12", "name": "卫十四", "sex": "女", "age": "24", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "13", "name": "蒋十五", "sex": "男", "age": "35", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "14", "name": "沈十六", "sex": "女", "age": "26", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "15", "name": "韩十七", "sex": "男", "age": "38", "role": "慈善跑者", "state": "-", "number": "-" },
        { "id": "16", "name": "杨十八", "sex": "女", "age": "32", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "17", "name": "朱十九", "sex": "男", "age": "37", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "18", "name": "秦二十", "sex": "女", "age": "28", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "19", "name": "尤二十一", "sex": "男", "age": "39", "role": "普通跑者", "state": "待抽签", "number": "-" },
        { "id": "20", "name": "许二十二", "sex": "女", "age": "30", "role": "普通跑者", "state": "待抽签", "number": "-" }
      ],
      currentPage: 1,
      pageSize: 8,
    };
...
.custom-button {
  background-color: #ff4081; /* 自定义按钮背景颜色 */
  color: white; /* 自定义按钮文字颜色 */
  border: none; /* 去掉边框 */
}

.custom-button:hover {
  background-color: #ff79a6; /* 自定义按钮悬停背景颜色 */
}
